...
public class PlayerManager : MonoBehaviourPunCallbacks
{
    ...
    [SerializeField] private GameObject mainCamera; // ?†Ïèô?ôÂç†?ôÏòô Ïπ¥Âç†?®Îù∞??
    [SerializeField] private GameObject playerCamera; // ?†ÏãúÎ§ÑÏòô?†Ïã±?¥Î? ?†Ïèô?ôÂç†?ôÏòô?üÂç†?Ïπ¥Âç†?®Îù∞??
    ...
    {   
        ...
        GameObject CharacterCamera = Instantiate(playerCamera) as GameObject; // ?†ÏãúÎ§ÑÏòô?†Ïã±?¥Îßà?†Ïèô???†Ïèô?ôÂç†?ôÏòô Ïπ¥Âç†?®Îù∞??
        CharacterCamera.GetComponent<cameraController>().target = m_isMinePlayer;
        CharacterCamera.GetComponent<Camera>().depth = 0; // ?†ÏãúÎ§ÑÏòô?†Ïã±?µÏòô Ïπ¥Âç†?®Îù∞???úÂç†?ôÏòô??
